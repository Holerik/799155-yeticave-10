...
<!---------------------------------------------------------------------------->
      <div class="form__item form__item--file">
        ...
        <div class="form__input-file">
          <input class="visually-hidden" type="file" name="avatar" id="avatar_id" value="" onChange="set_avatar()">
          <label for="avatar_id">
            Выбрать
          </label>
          ...
          <?php elseif (!empty($userInfo['avatar'])) :?>  
            <span class="form__item--avatar">Файл аватара выбран</span>
          <?php else: ?>
            <input type="text" class="form__hidden form__item--avatar" name="info_path" value="">
          <?php endif; ?>
        </div>
      </div>
<!----------------------------------------------------------------------------->
...
<footer class="main-footer">
  ...
  <div class="main-footer__bottom container">
    ...
    <a class="main-footer__add-lot form__error button" href="add.php">Добавить лот</a>
