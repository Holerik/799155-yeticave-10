...
<div class="page-wrapper">
  ...
  <nav class="nav">
    ...
    <form class="form form--add-lot container <?=Modify_When_error($errors, "", 'form--invalid');?>" action="add.php" method="post" target="_self" enctype="multipart/form-data" name="add_lot"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
        <div class="form__item  <?=Modify_When_error($errors, 'lot-name', 'form__item--invalid');?>"> <!-- form__item--invalid -->
          ...
          <?php else: ?>
            <!--<span class="form__item">Введите наименование лота</span>-->
          <?php endif; ?>
        </div>
        <!-- Список категорий товаров -->
        <div class="form__item <?=Modify_When_error($errors, 'category', 'form__item--invalid');?>">
          ...
          <?php else: ?>
            <!--<span class="form__item">Выберите категорию</span>-->
          <?php endif; ?>
        </div>
      </div>
      <div class="form__item form__item--wide <?=Modify_When_error($errors, 'message', 'form__item--invalid');?>">
        ...
        <?php else: ?>
        <!--<span class="form__item">Напишите описание лота</span>-->
        <?php endif;?>
      </div>
      <div class="form__item form__item--file <?=Modify_When_error($errors, 'lot-img', 'form__item--invalid');?>">
        <label>Изображение <sup>*</sup></label>
        <div class="form__input-file">
          <input class="visually-hidden" type="file" name="lot_img" id="lot-img" value="" onChange="set_info()">
          <label for="lot-img">
            Выбрать
          </label>
            ...
            <?php elseif (!empty($lotInfo['lot-img'])) :?>  
              <span class="form__item--info">Файл изображения выбран</span>
            <?php else: ?>
