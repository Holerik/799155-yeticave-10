...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if ($user_id > 0) {
        $sql = "SELECT r.id, r.price, r.lot_id, r.dt_add, img_url, l.name, descr," .
        " dt_fin, cat_id, info  FROM rates r JOIN lots l ON r.lot_id = l.id  ".
        "JOIN users u ON u.id = r.user_id WHERE r.user_id = $user_id" . 
